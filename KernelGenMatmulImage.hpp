#ifndef _GATLAS_KERNEL_GEN_MATMUL_IMAGE_HPP_
#define _GATLAS_KERNEL_GEN_MATMUL_IMAGE_HPP_
...
// general matrix multiply using image textures
class KernelGenMatmulImage : public KernelGenMatmul
{
    int _handleA;
    int _handleB;
    int _handleC;
...
public:
    KernelGenMatmulImage(const bool transposeA = false,
                         const bool transposeB = false);

    ~KernelGenMatmulImage();
